...
package com.example.collector.TFLiteCustom
...
import com.example.collector.TFLiteCustom.ImageUtils
  ...
  private fun getInterpreter(){
    ...
    FirebaseModelManager.getInstance().download(remoteModel, conditions)
      .addOnCompleteListener {
        ...
        Log.d("SegmentationExecutor", "Successfully downloaded")
      }
